...
(function (KI) {
  ...
  S.push({
    ...
    sentences: [
      ...
      { en: 'Then she packed two lunch boxes on the counter: one for Elif, one for Emre.', tr: 'Sonra tezgahın üstünde iki beslenme çantası hazırladı: biri Elif için, biri Emre için.', brk: true },
      ...
      { en: 'While the children were eating breakfast, Ayşe went to wash her hands at the sink.', tr: 'Çocuklar kahvaltı yaparken Ayşe elini yıkamak için lavaboya gitti.', brk: true },
      ...
      { en: 'Next, Mehmet called a roofer named Hasan, who lived two streets away.', tr: 'Ardından Mehmet, iki sokak ötede oturan Hasan adında bir çatıcıyı aradı.', brk: true },
      ...
      { en: 'After breakfast, he walked out to the garden to check one more problem.', tr: 'Kahvaltıdan sonra bir sorunu daha kontrol etmek için bahçeye çıktı.', brk: true },
      ...
      { en: 'Before going back inside, he stopped by the small chicken coop in the corner of the yard.', tr: 'İçeri girmeden önce bahçenin köşesindeki küçük kümesin yanına uğradı.', brk: true },
      ...
      { en: 'By the time Mehmet finished all his small jobs, the school bus was honking outside.', tr: 'Mehmet tüm küçük işlerini bitirdiğinde okul servisi dışarıda korna çalıyordu.', brk: true },
  ...
  /* ---- Günlük Hayat'ın ikinci hikayesi: bir çiftin akşam yürüyüşü, sokak
     satıcısı çocuk, dolmuş yolculuğu ve markette geçen gündelik anlar. ---- */
  S.push({
    id: 'aksam-yuruyusu',
    cat: 'gunluk',
    title: 'An Evening Walk',
    tr: 'Bir Akşam Yürüyüşü',
    summary: 'Bir çift akşam yürüyüşünde yosunlu bir ağaç kabuğu üzerine şakalaşır, bir dolmuşla markete gider ve eve dönüp sakin bir akşam geçirir.',
    sentences: [
      { en: 'On a warm evening, Zeynep and Yusuf decided to take a walk around their neighborhood.', tr: 'Bir akşam, Zeynep ve Yusuf mahallelerinde yürüyüşe çıkmaya karar verdi.' },
      { en: 'They walked slowly, side by side, looking at the streets and the old trees.', tr: 'Yan yana, ağır ağır yürüyerek sokaklara ve yaşlı ağaçlara baktılar.' },
      { en: 'Near the small park, they stopped to look closely at an old tree.', tr: 'Küçük parkın yakınında, yaşlı bir ağaca yakından bakmak için durdular.' },
      { en: 'Soft green moss was growing on the tree\'s bark, covering it like a thin blanket.', tr: 'Ağacın kabuğunda, ince bir örtü gibi onu kaplayan yumuşak yeşil yosunlar yetişiyordu.' },
      { en: '"Look at this moss," said Zeynep, "it makes the bark look so old and soft."', tr: 'Zeynep, "Şu yosunlara bak," dedi, "kabuğu ne kadar eski ve yumuşak gösteriyor."' },
      { en: '"It is funny," she added, "our hair turns gray with age, and the tree\'s bark turns mossy."', tr: '"Komik bir şey," diye ekledi, "bizim saçlarımız yaşla birlikte beyazlıyor, ağacın kabuğu da yosunlanıyor."' },
      { en: 'Yusuf laughed and shook his head. "Come on," he said, "we are only thirty."', tr: 'Yusuf güldü ve başını salladı. "Hadi oradan," dedi, "daha otuz yaşındayız."' },
      { en: '"Thirty is still young for gray hair, but maybe not for tired eyes," Zeynep joked.', tr: 'Zeynep şakayla, "Otuz yaş beyaz saç için hâlâ genç sayılır, ama belki yorgun gözler için değil," dedi.' },
      { en: 'They both laughed and continued walking along the quiet street.', tr: 'İkisi de güldü ve sessiz sokakta yürümeye devam ettiler.' },
      { en: 'A few minutes later, a small boy ran up to them with a basket of flowers.', tr: 'Birkaç dakika sonra, elinde bir sepet çiçekle küçük bir çocuk yanlarına koştu.', brk: true },
      { en: '"Would you like to buy some flowers, sir?" the boy asked politely.', tr: 'Çocuk kibarca, "Çiçek almak ister misiniz beyefendi?" diye sordu.' },
      { en: 'Yusuf reached for his wallet, but Zeynep gently stopped his hand.', tr: 'Yusuf cüzdanına uzandı, ama Zeynep elini nazikçe durdurdu.' },
      { en: '"I do not think we should buy from him," she said quietly.', tr: '"Bence ondan almamalıyız," dedi sessizce.' },
      { en: '"Why not? The flowers look fresh," Yusuf asked, confused.', tr: 'Yusuf şaşırarak, "Neden? Çiçekler taze görünüyor," diye sordu.' },
      { en: '"Because children like him are often sent out by adults who take the money," Zeynep explained.', tr: 'Zeynep, "Çünkü onun gibi çocuklar genellikle parayı alan yetişkinler tarafından sokağa gönderiliyor," diye açıkladı.' },
      { en: '"Buying from him will not help him, it will only help the people using him," she said.', tr: '"Ondan almak ona yardım etmez, sadece onu kullanan kişilere yardım eder," dedi.' },
      { en: 'Yusuf nodded slowly and understood her point.', tr: 'Yusuf yavaşça başını salladı ve onun ne demek istediğini anladı.' },
      { en: 'Instead, he smiled at the boy and said, "Not today, but take care of yourself."', tr: 'Bunun yerine çocuğa gülümsedi ve "Bugün olmaz ama kendine iyi bak," dedi.' },
      { en: 'The boy nodded and ran off to find other customers.', tr: 'Çocuk başını salladı ve başka müşteriler bulmak için koşarak uzaklaştı.' },
      { en: 'Soon after, Zeynep and Yusuf reached the main road and waited for a dolmuş.', tr: 'Kısa bir süre sonra Zeynep ve Yusuf ana caddeye ulaştı ve bir dolmuş beklediler.', brk: true },
      { en: 'A dolmuş stopped, and they got in and sat next to an elderly woman.', tr: 'Bir dolmuş durdu ve içine binip yaşlı bir kadının yanına oturdular.' },
      { en: 'The old woman looked at Zeynep\'s dress and smiled warmly.', tr: 'Yaşlı kadın Zeynep\'in elbisesine baktı ve sıcak bir şekilde gülümsedi.' },
      { en: '"What a beautiful dress, dear," she said, "the color really suits you."', tr: '"Ne kadar güzel bir elbise canım," dedi, "bu renk sana çok yakışmış."' },
      { en: '"Thank you very much," Zeynep replied with a happy smile.', tr: 'Zeynep mutlu bir gülümsemeyle, "Çok teşekkür ederim," diye karşılık verdi.' },
      { en: 'They talked a little more about the weather until the dolmuş reached the market.', tr: 'Dolmuş markete varana kadar hava durumu hakkında biraz daha konuştular.' },
      { en: 'The supermarket was very large, with long aisles full of every kind of product.', tr: 'Market çok büyüktü, her türlü ürünle dolu uzun reyonları vardı.', brk: true },
      { en: 'Yusuf immediately walked toward the tools and hardware section.', tr: 'Yusuf hemen alet ve hırdavat bölümüne yöneldi.' },
      { en: 'He picked up a new screwdriver, then a hammer, then a box of nails.', tr: 'Önce yeni bir tornavida, sonra bir çekiç, sonra bir kutu çivi aldı.' },
      { en: '"Do we really need all of this?" Zeynep asked, looking at the growing pile in the cart.', tr: 'Zeynep, sepette büyüyen yığına bakarak, "Bunların hepsine gerçekten ihtiyacımız var mı?" diye sordu.' },
      { en: '"You can buy it, of course," she said with a smile, "and then I will make you work in the garden all weekend."', tr: 'Gülümseyerek, "Tabii ki alabilirsin," dedi, "sonra da seni bütün hafta sonu bahçede çalıştırırım."' },
      { en: 'Yusuf laughed loudly. "That sounds like a fair deal," he said.', tr: 'Yusuf kahkaha attı. "Bu adil bir anlaşma gibi görünüyor," dedi.' },
      { en: 'He added one more item, a small paintbrush, and finally stopped.', tr: 'Bir tane daha ekledi, küçük bir boya fırçası, ve sonunda durdu.' },
      { en: 'At the checkout, a young cashier looked at all the tools with surprise.', tr: 'Kasada, genç bir kasiyer tüm aletlere şaşkınlıkla baktı.', brk: true },
      { en: '"What are you going to do with so many tools?" she asked. "Are you a contractor?"', tr: '"Bu kadar aletle ne yapacaksınız?" diye sordu. "İnşaatçı mısınız?"' },
      { en: 'Yusuf and Zeynep looked at each other and started laughing.', tr: 'Yusuf ve Zeynep birbirlerine baktı ve gülmeye başladılar.' },
      { en: '"No, just a husband with a long list of small jobs at home," Yusuf answered.', tr: 'Yusuf, "Hayır, sadece evde uzun bir iş listesi olan bir koca," diye cevap verdi.' },
      { en: 'The cashier laughed too and packed everything carefully into bags.', tr: 'Kasiyer de güldü ve her şeyi torbalara özenle yerleştirdi.' },
      { en: 'When they got home, it was already getting late.', tr: 'Eve vardıklarında hava iyice geç olmuştu.', brk: true },
      { en: 'Yusuf sat down at the computer to check his messages for a few minutes.', tr: 'Yusuf birkaç dakikalığına mesajlarına bakmak için bilgisayarın başına oturdu.' },
      { en: 'Since there was no time for a big dinner, Zeynep decided to make something quick.', tr: 'Büyük bir yemek için vakit olmadığından Zeynep hızlıca bir şeyler yapmaya karar verdi.' },
      { en: 'She boiled some pasta and prepared a simple sauce with minced meat and tomatoes.', tr: 'Makarna kaynattı ve kıyma ile domatesten basit bir sos hazırladı.' },
      { en: 'She poured the meat sauce over the pasta and called Yusuf to the table.', tr: 'Kıymalı sosu makarnanın üstüne döktü ve Yusuf\'u masaya çağırdı.' },
      { en: 'They sat together, ate their dinner, and watched a short movie.', tr: 'Birlikte oturdular, yemeklerini yediler ve kısa bir film izlediler.', brk: true },
      { en: 'After the movie, they performed their evening prayer together.', tr: 'Filmden sonra birlikte akşam namazını kıldılar.' },
      { en: 'Finally, tired but content, they turned off the lights and went to sleep.', tr: 'Sonunda, yorgun ama huzurlu bir şekilde ışıkları kapatıp uyudular.' }
    ]
  });

  /* ---- yukarıdaki hikayede geçen, sözlükte eksik kelimeler ---- */
  KI.glossary.addWords([
    'closely|yakından, dikkatle|zarf', 'mossy|yosunlu|sıfat', 'maybe|belki|zarf',
    'sir|efendim, beyefendi|isim', 'politely|kibarca|zarf', 'nod|başını sallamak|fiil',
    'yourself|kendin, kendini|zamir', 'supermarket|süpermarket|isim', 'aisle|reyon, koridor|isim',
    'section|bölüm|isim', 'item|eşya, ürün|isim', 'paintbrush|boya fırçası|isim',
    'checkout|kasa (ödeme yeri)|isim', 'contractor|müteahhit, inşaatçı|isim', 'quick|hızlı, çabuk|sıfat',
