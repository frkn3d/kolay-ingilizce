...
(function (KI) {
  ...
  var SHAPES = {
    ...
    briefcase: '<rect x="3" y="8" width="18" height="11" rx="1.6"/><path d="M9 8V6a1.6 1.6 0 0 1 1.6-1.6h2.8A1.6 1.6 0 0 1 15 6v2"/><line x1="3" y1="13" x2="21" y2="13"/>',
    'graduation-cap': '<polygon points="12,5 21,9.5 12,14 3,9.5"/><path d="M7 11.5v4.3c0 1.4 2.2 2.6 5 2.6s5-1.2 5-2.6v-4.3"/><line x1="21" y1="9.5" x2="21" y2="15.5"/>',
    phone: '<rect x="7" y="2.5" width="10" height="19" rx="1.8"/><line x1="10" y1="18.2" x2="14" y2="18.2"/>',
    laptop: '<rect x="4" y="5" width="16" height="10.5" rx="1.2"/><path d="M2 18.5h20l-1.6-2.2a1.5 1.5 0 0 0-1.2-.6H4.8a1.5 1.5 0 0 0-1.2.6Z"/>',
    ball: '<circle cx="12" cy="12" r="9"/><polygon points="12,7.5 15.5,10 14.2,14 9.8,14 8.5,10"/><line x1="12" y1="3" x2="12" y2="7.5"/><line x1="15.5" y1="10" x2="19.5" y2="8.5"/><line x1="14.2" y1="14" x2="16.5" y2="18"/><line x1="9.8" y1="14" x2="7.5" y2="18"/><line x1="8.5" y1="10" x2="4.5" y2="8.5"/>',
    'music-note': '<circle cx="7" cy="18" r="2.6"/><circle cx="17" cy="16" r="2.6"/><path d="M9.6 18V5.5L19.6 3.5V16"/>',
    'film-clapper': '<path d="M3 10.5 4 6.8l14.5 3-1 3.7Z"/><path d="M3.5 9 17 5.5"/><rect x="3" y="10.5" width="18" height="9" rx="1.2"/>',
    flower: '<circle cx="12" cy="12" r="2.2" fill="currentColor" stroke="none"/><circle cx="12" cy="6.8" r="2.8"/><circle cx="17.2" cy="12" r="2.8"/><circle cx="12" cy="17.2" r="2.8"/><circle cx="6.8" cy="12" r="2.8"/>',
    fish: '<path d="M3 12c3-4 8-5.5 12-3.5 2 1 4 1 4 1s-1 2-2.5 2.5c1.5.5 2.5 2.5 2.5 2.5s-2 0-4 1c-4 2-9 .5-12-3.5Z"/><circle cx="7.3" cy="11" r=".7" fill="currentColor" stroke="none"/><path d="M3 12 1 9.5M3 12 1 14.5"/>',
    snowflake: '<line x1="12" y1="2.5" x2="12" y2="21.5"/><line x1="4" y1="7" x2="20" y2="17"/><line x1="4" y1="17" x2="20" y2="7"/><path d="M12 6 9.7 4M12 6l2.3-2M12 18l-2.3 2M12 18l2.3 2"/>',
    umbrella: '<path d="M3 12a9 9 0 0 1 18 0Z"/><line x1="12" y1="12" x2="12" y2="20"/><path d="M12 20a2 2 0 0 1-4 0"/><line x1="12" y1="3" x2="12" y2="5"/>',
    gift: '<rect x="4" y="10" width="16" height="10" rx="1"/><line x1="4" y1="14" x2="20" y2="14"/><line x1="12" y1="10" x2="12" y2="20"/><path d="M12 10c-2-4-6-4-6-1.5S9 10 12 10Z"/><path d="M12 10c2-4 6-4 6-1.5S15 10 12 10Z"/>',
    envelope: '<rect x="3" y="5.5" width="18" height="13" rx="1.6"/><path d="M3.5 6.5 12 13l8.5-6.5"/>',
    train: '<rect x="5.5" y="4" width="13" height="12" rx="3"/><line x1="5.5" y1="10.5" x2="18.5" y2="10.5"/><circle cx="9" cy="18.5" r="1.3"/><circle cx="15" cy="18.5" r="1.3"/><path d="M8 16.3 5.5 19.5M16 16.3l2.5 3.2"/>',
    camera: '<path d="M4 8h3.2l1.3-2h6.8l1.3 2H20a1.5 1.5 0 0 1 1.5 1.5v9A1.5 1.5 0 0 1 20 20H4a1.5 1.5 0 0 1-1.5-1.5v-9A1.5 1.5 0 0 1 4 8Z"/><circle cx="12" cy="14" r="3.6"/>',
    kite: '<polygon points="12,3 19,10 12,21 5,10"/><line x1="12" y1="3" x2="12" y2="21"/><line x1="5" y1="10" x2="19" y2="10"/><path d="M12 21c1 1.5 0 3-1.5 2.5"/>',
    bicycle: '<circle cx="6" cy="17" r="3.3"/><circle cx="18" cy="17" r="3.3"/><path d="M6 17 10 8h5l3 9M10 8 8.5 5h-2"/><line x1="10" y1="8" x2="13.5" y2="13"/><line x1="13.5" y1="13" x2="18" y2="17"/><line x1="13.5" y1="13" x2="6" y2="17"/>',
    clock: '<circle cx="12" cy="12" r="9"/><line x1="12" y1="12" x2="12" y2="7"/><line x1="12" y1="12" x2="15.5" y2="14"/>',
    paintbrush: '<path d="M19 3c-3 0-9 4.5-11.5 9.5l3 3C15.5 13 20 7 20 4a1 1 0 0 0-1-1Z"/><path d="M9.5 13.5c-.5 2-2 2.5-2 4.5 0 1.5 1.2 2.7 2.7 2.7 2 0 2.5-1.5 4.5-2Z"/>',
